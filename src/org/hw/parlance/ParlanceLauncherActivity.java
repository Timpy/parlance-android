 ...
 *
 */
public class ParlanceLauncherActivity extends Activity {
	...
	protected void onServiceReady() {
		final Class<? extends Activity> classToStart;
			classToStart = ParlanceActivity.class;
		LinphoneService.instance().setActivityToLaunchOnIncomingReceived(classToStart);
		mHandler.postDelayed(new Runnable() {
			@Override
			public void run() {
				startActivity(new Intent().setClass(ParlanceLauncherActivity.this, classToStart).setData(getIntent().getData()));
				finish();
			}
		}, 1000);
	}
