...
public class ContactsFragment extends Fragment implements OnClickListener, OnItemClickListener {
	...
	public void onClick(View v) {
		...
		if (id == R.id.allContacts) {
			...
			editConsumed = true;
			//ParlanceActivity.instance().addContact(null, sipAddressToAdd);
		} 
	}
	...
	private void changeContactsAdapter() {
		...
		Cursor allContactsCursor = ParlanceActivity.instance().getAllContactsCursor();
		Cursor sipContactsCursor = ParlanceActivity.instance().getSIPContactsCursor();
		...
		if (onlyDisplayLinphoneContacts) {
			...
			//	contactsList.setAdapter(new ContactsListAdapter(ParlanceActivity.instance().getSIPContacts(), sipContactsCursor));
			}
		} else {
			...
			//	contactsList.setAdapter(new ContactsListAdapter(ParlanceActivity.instance().getAllContacts(), allContactsCursor));
			}
		}
		//ParlanceActivity.instance().setLinphoneContactsPrefered(onlyDisplayLinphoneContacts);
	}
	...
	public void onItemClick(AdapterView<?> adapter, View view, int position, long id) {
		...
		if (editOnClick) {
			editConsumed = true;
			//ParlanceActivity.instance().editContact(contact, sipAddressToAdd);
		} else {
			lastKnownPosition = contactsList.getFirstVisiblePosition();
			//ParlanceActivity.instance().displayContact(contact, onlyDisplayChatAddress);
		}
	}
	...
	public void onResume() {
		...
		if (ParlanceActivity.isInstanciated()) {
			ParlanceActivity.instance().selectMenu(FragmentsAvailable.CONTACTS);
			//onlyDisplayLinphoneContacts = ParlanceActivity.instance().isLinphoneContactsPrefered();
		}
	...
	class ContactsListAdapter extends BaseAdapter implements SectionIndexer {
		...
		public View getView(int position, View convertView, ViewGroup parent) {
			...
			if (!ParlanceActivity.instance().isContactPresenceDisabled() && friend != null) {
